...
<!-- 사용할 부분 board list 시작-->
        ...
        <br>
      		<div class="table-area">
      		 <h2 class="b_title" style="color:#6495ED;">Notice</h2>
  				<form action="nInsert.no" method="post" id="noticeWriteForm">
...
<!--                     	</tr> -->
	    				<tr>
	                          ...
	                          <td class="td_content" colspan="10">
	                             <input type="text" id="q_Title" name="noticeTitle" required>
	                            
	                          &emsp;&emsp;<input class="form-check-input" type="checkbox" id="flexCheckChecked" name= "fix">
	                      ...
	                      <tr>
	                          <td colspan="6"><textarea cols="200px" rows="200px" style="resize:none;" name="noticeContent" required></textarea></td>
	                      </tr>
                      </table>
